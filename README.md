...
```bash
npm i @erboladaiorg/magnam-tempora
```
...
## Simple Usage
```js
const {get} = require("@erboladaiorg/magnam-tempora");
...
```js
const {get, escape} = require("@erboladaiorg/magnam-tempora");
...
```js
const {chop} = require("@erboladaiorg/magnam-tempora");
...
```js
const {clean} = require("@erboladaiorg/magnam-tempora");
...
```js
const {countLeafNodes} = require("@erboladaiorg/magnam-tempora");
...
```js
const {countMatchingPathsInObject} = require("@erboladaiorg/magnam-tempora");
...
```js
const {decouple} = require("@erboladaiorg/magnam-tempora");
...
```js
const {diff} = require("@erboladaiorg/magnam-tempora");
...
```js
const {distill} = require("@erboladaiorg/magnam-tempora");
...
```js
const {down} = require("@erboladaiorg/magnam-tempora");
...
```js
const {escape} = require("@erboladaiorg/magnam-tempora");
...
```js
const {findOnePath} = require("@erboladaiorg/magnam-tempora");
...
```js
const {findPath} = require("@erboladaiorg/magnam-tempora");
...
```js
const {flatten} = require("@erboladaiorg/magnam-tempora");
...
```js
const {flattenValues} = require("@erboladaiorg/magnam-tempora");
...
```js
const {furthest} = require("@erboladaiorg/magnam-tempora");
...
```js
const {set, get} = require("@erboladaiorg/magnam-tempora");
...
```js
const {setImmutable, get} = require("@erboladaiorg/magnam-tempora");
